    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
            ...
            <div class="space-y-1">
                ...
                <p class="text-gray-900 dark:text-white">{{ $spt->notaDinas->destination_display ?? '-' }}{{ $spt->notaDinas->destinationCity?->province ? ', ' . $spt->notaDinas->destinationCity->province->name : '' }}</p>
            </div>
            <div class="space-y-1">
