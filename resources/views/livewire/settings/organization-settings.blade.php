<div class="space-y-8">
    ...
    <form wire:submit="save" class="space-y-8">
        ...
        <!-- System Maintenance -->
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg border-2 border-orange-300 dark:border-orange-700">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-orange-50 dark:bg-orange-900/20">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Nonaktifkan akses sistem untuk pemeliharaan</p>
                    </div>
                </div>
            </div>
            <div class="p-6 space-y-6">
                ...
                <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-md p-4">
                    <div class="flex">
                        ...
                        <div class="text-sm text-yellow-700 dark:text-yellow-300">
                            ...
                            <p>Ketika maintenance mode diaktifkan, semua pengguna (kecuali superadmin) tidak dapat mengakses sistem dan akan melihat halaman maintenance.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="flex items-center cursor-pointer">
                            <input 
                                ...
                                class="rounded border-gray-300 text-orange-600 shadow-sm focus:border-orange-300 focus:ring focus:ring-orange-200 focus:ring-opacity-50 w-5 h-5"
                            />
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            rows="4"
                            placeholder="Sistem sedang dalam perbaikan. Silakan coba lagi nanti."
                            class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                        ></textarea>
                        @error('maintenance_message') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Pesan yang akan ditampilkan kepada pengguna saat sistem dalam mode maintenance
                        </p>
                    </div>
                </div>
            </div>
