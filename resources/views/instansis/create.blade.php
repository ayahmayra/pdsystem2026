<x-layouts.app.sidebar title="Tambah Instansi">
    <flux:main>
<div class="space-y-6">
    <!-- Header -->
    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Tambah Instansi</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Tambahkan instansi baru ke sistem</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <form method="POST" action="{{ route('instansis.store') }}">
                @csrf
