                ...
                <form method="POST" action="{{ route('districts.update', $district) }}">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="capital_name" id="capital_name" 
                                   value="{{ old('capital_name', $district->capital_name) }}"
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm @error('capital_name') border-red-500 @enderror"
